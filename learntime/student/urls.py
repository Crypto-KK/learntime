...
from learntime.student.views import (StudentExcelImportView, StudentExcelExportView, StudentBulkDeleteView, \
                                     ...
                                     StudentCreditVerifyDeleteView, EditFailRecord)
...
urlpatterns = [
    ...
    path("edit-fail-record/", view=EditFailRecord.as_view(), name='edit_fail_record'),
    ...
    # 手动补录学时页
    path('credit-apply-manually/', view=StudentCreditApplyManuallyCreateView.as_view(), name='student_credit_apply_manually'),
